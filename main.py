...
workouts = pd.read_csv('datasets/workout_df.csv')
...
def helper(dis):
    ...
    workout = workouts[workouts['disease'] == dis]['workout']
...
def predict():
    if request.method == 'POST':
        ...
        for i in pre[0]:
            my_pre.append(i)
        return render_template('index.html', predicted_disease=predicted_disease, dis_des=desc, dis_pre=my_pre, dis_med=med, dis_die=die, dis_wrk=workout)
